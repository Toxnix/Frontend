...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("de.bacherik.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("de.bacherik.security.DomainUserDetailsService", "createSpringSecurityUser");
